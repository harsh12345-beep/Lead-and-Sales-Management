...
//     setEditItem({ ...item }); // Ensure it's a new object, not a reference
...
//     console.log("Sending payload:", newItem); // Debugging
...
//                 <button type="button" onClick={handleCloseModals} className="px-4 py-2 bg-gray-400 text-white rounded">Cancel</button>
...
//               <input type="text" name="title" placeholder="Title" onChange={handleInputChange} className="w-full mb-3 p-2 border rounded" />
//               <input type="text" name="type" placeholder="Type" onChange={handleInputChange} className="w-full mb-3 p-2 border rounded" />
//               <input type="number" name="pricePerItem" placeholder="Price" onChange={handleInputChange} className="w-full mb-3 p-2 border rounded" />
//               <input type="number" name="totalStock" placeholder="Stock" onChange={handleInputChange} className="w-full mb-3 p-2 border rounded" />
//               <div className="flex justify-between">
//                 <button type="button" onClick={handleCloseModals} className="px-4 py-2 bg-gray-400 text-white rounded">Cancel</button>
      ...
      {showAddModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-opacity-50">
          <div className="bg-white p-6 rounded-lg w-96">
            <h2 className="text-xl font-bold mb-4">Add New Item</h2>
            <form onSubmit={handleAddItem}>
              <input type="text" name="title" value={newItem?.title || ""} onChange={handleInputChange} className="w-full mb-3 p-2 border rounded" />
              <input type="text" name="type" value={newItem?.type || ""} onChange={handleInputChange} className="w-full mb-3 p-2 border rounded" />
              <input type="number" name="pricePerItem" value={newItem?.pricePerItem || ""} onChange={handleInputChange} className="w-full mb-3 p-2 border rounded" />
              <input type="number" name="totalStock" value={newItem?.totalStock || ""} onChange={handleInputChange} className="w-full mb-3 p-2 border rounded" />
              <div className="flex justify-between">
                <button type="button" onClick={handleCloseModals} className="px-4 py-2 bg-gray-400 text-white rounded">
                  Cancel
                </button>
